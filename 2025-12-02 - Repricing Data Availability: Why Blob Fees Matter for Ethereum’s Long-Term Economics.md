...
Traditional capacity bumps need full hard forks. Blob demand from L2s is more dynamic.

BPO forks are lightweight “mini-forks” that only adjust blob parameters (e.g., target & max blobs), not core client logic.
...
Data availability & blobs (EIP-7594, 7892, 7918)
Execution scaling & DoS hardening (EIP-7935, 7825, 7934, 7823, 7883)
Crypto & UX primitives (EIP-7951, 7917, 7939)
Node health & config tooling (EIP-7642, 7910)

Sources:

Ethereum Blog, CoinGecko, CoinDesk, TheDefiant, Blockworks
CoinTelegraph: ref-1, ref-2
Crypto.com, DLnews Datawallet
X: ethereum, solidity_lang, jarrodwatts, jarrodwatts (2), den0thic, l3olanza, sassal0x, Snapcrackle, 0xNairolf, iamjosephyoung, safe, TheMoneyApe
